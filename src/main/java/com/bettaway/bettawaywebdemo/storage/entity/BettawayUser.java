...
/**
 * This class does not use Project-Lombok because most of code in this 
 * kind of entity classes are automatically generated by Netbeans. In 
 * practice, there will be many entity classes. Also, during the development, the 
 * entity files are the most frequently changing files, which means they will be 
 * re-generated by Netbeans many times. In that way, the plugged-in lombok code 
 * will be erased. If lombok every class, it would be unnecessarily time-consuming . 
 *
 * @author Zhijun Zhang
 */
@Entity
